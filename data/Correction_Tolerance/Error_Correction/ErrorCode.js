...
const errorCodeData = {
    ...
    details: {
        'Shor code': {
            ...
            process: `Shor code 是第一個完整的量子糾錯碼。<br>
它巧妙地結合了經典的三位元重複碼，同時糾正 bit-flip 和 phase-flip 錯誤。<br>
<br>
<strong>文獻：</strong>
...
Physical Review A 52, 2493 (1995)`,
        ...
        'Steane code': {
            ...
            process: `Steane code 是第一個 CSS (Calderbank-Shor-Steane) 碼。<br>
基於經典的 Hamming(7,4) 碼構造。<br>
<br>
<strong>文獻：</strong>
...
Physical Review Letters 77, 793 (1996)`,
        ...
        'CSS code': {
            ...
            process: `CSS碼提供了一種從經典碼構造量子碼的系統方法。<br>
<br>
<strong>文獻：</strong>
...
Physical Review A 54, 1098 (1996)`,
        ...
        'Stabilizer code': {
            ...
            process: `穩定子形式主義是描述量子糾錯碼最優雅、最強大的數學語言。<br>
<br>
<strong>文獻：</strong>
...
Ph.D. Thesis, Caltech (1997)`,
        ...
        'Surface code': {
            ...
            process: `Surface code 目前被認為是最有可能實現容錯量子計算的碼。<br>
容錯閾值約為 1%，遠高於其他碼。<br>
<br>
<strong>文獻：</strong>
...
Quant. Inf. Comp. 6, 97-165 (2006)`,
        ...
        'Toric code': {
            ...
            process: `Toric code 是拓撲量子糾錯的開創性工作。<br>
展示了拓撲保護的強大之處。<br>
<br>
<strong>文獻：</strong>
