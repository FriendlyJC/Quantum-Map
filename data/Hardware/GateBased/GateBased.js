...
const gateBasedData = {
    // 節點位置配置
    items: [
        { name: 'Superconducting', year: 1999, x: 1635, y: 675 },
        { name: 'Ion trap', year: 1995, x: 1635, y: 575 },
        { name: 'Photonic', year: 2001, x: 1635, y: 725 },
        { name: 'NV center', year: 1997, x: 1635, y: 625 },
        { name: 'Topological', year: 2003, x: 1635, y: 775 }
    ],
    ...
    details: {
        'Superconducting': {
            ...
            process: `超導量子位元是目前最成熟的量子計算平台之一。<br>
<br>
<strong>優點：</strong><br>
• 製造可擴展性好（半導體工藝）<br>
• 閘操作速度快（納秒級）<br>
...
<strong>代表公司：</strong>IBM, Google, Rigetti`,
        ...
        'Ion trap': {
            ...
            process: `離子阱是最早實現量子閘操作的物理平台之一。<br>
<br>
<strong>優點：</strong><br>
• 極長的相干時間（秒級）<br>
• 極高的閘保真度（>99.9%）<br>
