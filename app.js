        ...
        if (!isDragging) {
            ...
            if (!clickedItem) {
                const categoryTitles = [
                    ...
                    { name: '糾錯與容錯', x: 1250, y: 150, rx: 100, ry: 35 },
                    { name: '硬體', x: 1440, y: 150, rx: 100, ry: 35 }
                ];
            ...
            if (!clickedItem) {
                const subcategoryTitles = [
                    ...
                    { name: '不可複製', x: 910, y: 217, width: 80, height: 28 },
                    { name: '密碼學', x: 995, y: 217, width: 70, height: 28 },
                    { name: '通訊', x: 1080, y: 217, width: 60, height: 28 },
                    { name: '糾錯碼', x: 1250, y: 217, width: 75, height: 28 },
                    { name: 'Adiabatic', x: 1440, y: 217, width: 85, height: 28 },
                    { name: 'Gate-based', x: 1580, y: 217, width: 100, height: 28 }
                ];
...
function drawBackgrounds() {
    ...
    // 通訊協議 - 三个垂直条（橘、淺橘、橘）
    const commColumns = [
        { x: 870, width: 80, color: 'rgba(255, 160, 100, 0.30)' },   // 橘 - 不可複製
        { x: 950, width: 90, color: 'rgba(255, 160, 100, 0.20)' },   // 淺橘 - 密碼學
        { x: 1040, width: 80, color: 'rgba(255, 160, 100, 0.30)' }   // 橘 - 通訊
    ];
    
    // 糾錯與容錯 - 一个条（淺綠）
    const errorColumns = [
        { x: 1150, width: 200, color: 'rgba(130, 200, 130, 0.25)' }  // 淺綠 - 糾錯碼
    ];
    
    // 硬體 - 两个垂直条（紅、淺紅）
    const hardwareColumns = [
        { x: 1370, width: 140, color: 'rgba(230, 120, 120, 0.30)' }, // 紅 - Adiabatic
        { x: 1510, width: 140, color: 'rgba(230, 120, 120, 0.20)' }  // 淺紅 - Gate-based
    ];
...
function drawCategoryTitles() {
    const titles = [
        ...
        { text: '糾錯與容錯', x: 1250, y: 150, color: '#5FAD56', bgColor: 'rgba(130, 200, 130, 0.4)' },
        { text: '硬體', x: 1440, y: 150, color: '#E57373', bgColor: 'rgba(230, 120, 120, 0.4)' }
    ];
...
function drawSubcategoryTitles() {
    const subcategories = [
        ...
        // 通讯协议 - 三个子类别
        { text: '不可複製', x: 910, y: 217, color: 'rgba(255, 160, 100, 0.45)', width: 80 },
        { text: '密碼學', x: 995, y: 217, color: 'rgba(255, 160, 100, 0.35)', width: 70 },
        { text: '通訊', x: 1080, y: 217, color: 'rgba(255, 160, 100, 0.45)', width: 60 },
        
        // 纠错 - 一个子类别
        { text: '糾錯碼', x: 1250, y: 217, color: 'rgba(130, 200, 130, 0.4)', width: 75 },
        
        // 硬体 - 两个子类别
        { text: 'Adiabatic', x: 1440, y: 217, color: 'rgba(230, 120, 120, 0.45)', width: 85 },
        { text: 'Gate-based', x: 1580, y: 217, color: 'rgba(230, 120, 120, 0.35)', width: 100 }
    ];
